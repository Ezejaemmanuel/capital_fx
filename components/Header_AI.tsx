...
//                     </Link>
//                 </div>
//                 <div className="mt-8 lg:mt-0 flex justify-center items-center sm:col-span-1 md:col-span-6 lg:col-span-5">
//                     <motion.div
//                         initial={{ opacity: 0 }}
//                         animate={{ opacity: 1 }}
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto gap-8 xl:gap-0 lg:py-16 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-12">
                <div className="mr-auto place-self-center sm:col-span-1 md:col-span-6 lg:col-span-7">
                    <AnimatePresence mode='wait'>
                        <motion.h1
                            className="max-w-2xl mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight leading-none font-serif dark:text-white  bg-clip-text text-transparent"
                            key={index}
                            variants={textVariants}
                            initial="hidden"
                            animate="visible"
                    ...
                    <motion.p
                        className="max-w-2xl mb-6 font-light text-sm sm:text-base md:text-lg lg:text-xl dark:text-gray-400"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ duration: 0.25 }}
                    >
